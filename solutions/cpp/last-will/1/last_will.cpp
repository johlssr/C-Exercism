...
namespace estate_executor {
    ...
    int assemble_code() {
        int bluecode = khan::blue::code_fragment()+garcia::blue::code_fragment()+ zhang::blue::code_fragment();
        int redcode =  garcia::red::code_fragment()+khan::red::code_fragment()+zhang::red::code_fragment();
